...
public class SceneFavoritesOverlay : Overlay
{
    ...
    public override VisualElement CreatePanelContent()
    {
        ...
        UpdateSceneList("");
        searchField.SendEvent(new MouseDownEvent { target = searchField});
        return container;
    }
    ...
    private void UpdateSceneList(string searchTerm = "")
    {
        ...
        foreach (var scene in allScenes)
        {
            ...
            openLabel.RegisterCallback<ContextClickEvent>(_ => PingScene(scene));
            openLabel.tooltip = scene;
    ...
    void PingScene(string scenePath)
    {
